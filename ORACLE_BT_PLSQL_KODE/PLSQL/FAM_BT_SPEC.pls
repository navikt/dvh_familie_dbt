create or replace PACKAGE                                                                                                                                   fam_bt AUTHID CURRENT_USER AS
  ...
  PROCEDURE fam_bt2_slett_offset(p_in_offset IN VARCHAR2, p_error_melding OUT VARCHAR2);
  PROCEDURE fam_bt_utpakking_offset(p_in_offset IN NUMBER, p_error_melding OUT VARCHAR2);
  PROCEDURE fam_bt2_utpakking_offset(p_in_offset IN NUMBER, p_error_melding OUT VARCHAR2);
